...
for (i in 1:48) {
  pth=paste('C:/Users/Shabrez/Desktop/E10/a (',').pdf',sep=as.character(i))
  print(pth)
  pdf_convert(
    pth,
    format = "png",
...
for (i in 1:48) {
  pth=paste('C:/Users/Shabrez/Documents/a (',')_2.png',sep=as.character(i))
  ...
  ppp=paste('C:/Users/Shabrez/Documents/a_','.csv',sep=as.character(i))
